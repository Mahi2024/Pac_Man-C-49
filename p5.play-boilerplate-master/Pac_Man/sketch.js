...
for(var i = 0;i<140;i = i+20){
  p1 = createSprite(i,225,10,10,10);
  p1.shapeColor = "yellow";
  pelletsGroup.add(p1);
  if(Pac_Man.isTouching(pelletsGroup)){
    pelletsGroup.destroyEach(0);
  }
}
for(var i = 240;i<380;i = i+20){
  p2 = createSprite(125,i,10,10,10);
  p2.shapeColor = "yellow";
  if(Pac_Man.isTouching(p2)){
    p2.destroy();
  }
}
for(var i = 35;i<580;i = i+20){
  p3 = createSprite(i,370,10,10,10);
  p3.shapeColor = "yellow";
}
for(var i = 390;i<460;i = i+20){
  p4 = createSprite(30,i,10,10,10);
  p4.shapeColor = "yellow";
}
for(var i = 35;i<420;i = i+20){
  p5 = createSprite(i,450,10,10,10);
...
line(0,0,400,400);
  ...
  //disappearing pellets
  // if(Pac_Man.isTouching(p1)){
  //   p1.destroy(0);
  // }
  // if(Pac_Man.isTouching(p2)){
  //   p2.destroy(0);
